...
public final class DataVisualizer extends ApplicationTemplate {
    ...
    protected boolean propertyAudit() {
        boolean failed = manager == null || !(loadProperties(PROPERTIES_XML) && loadProperties(WORKSPACE_PROPERTIES_XML) && loadProperties(CLASSIFICATION_PROPERTIES_XML) && loadProperties(CLUSTERING_PROPERTIES_XML));
        if (failed)
    ...
    protected void userInterfaceAudit(Stage primaryStage) {
        ...
        setActionComponent(new AppActions(this, primaryStage));
